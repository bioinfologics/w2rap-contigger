...
class QualGrabber : public RecOItr {
  public:
    ...
    QualGrabber& operator*() {
        return *this;
    }
    QualGrabber& operator++() {
        return *this;
    }
    QualGrabber& operator++(int) {
        return *this;
    }
...
class RefLocGrabber : public RecOItr {
  public:
    ...
    RefLocGrabber& operator*() {
        return *this;
    }
    RefLocGrabber& operator++() {
        return *this;
    }
    RefLocGrabber& operator++(int) {
        return *this;
    }
...
class PairsBuilder : public RecOItr {
    ...
    PairsBuilder& operator*() {
        return *this;
    }
    PairsBuilder& operator++() {
        return *this;
    }
    PairsBuilder& operator++(int) {
        return *this;
    }
  ...
  public:
    ...
    ~PairsBuilder() {
        if ( mId > mpPM->nReads() ) mpPM->setNReads(mId);
    }
