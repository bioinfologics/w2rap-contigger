...
class BaseMetrics {
  ...
  public:
    ...
    void sort() {
        std::sort(mVals,mVals+4);
    }
    void reverseSort() {
        std::sort(mVals,mVals+4,std::greater<ValT>());
    }
...
void readstack::CorrectAllEM3( basevector& b, qualvector& q, int& trim_to, std::vector<double>& pfriend, bool debug ) const {
    StackBaseVec b_tmp;
    StackQualVec q_tmp;
