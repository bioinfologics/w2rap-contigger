...
class ConsensusScoreModel {
    ...
    int Score( const BaseVec& a, const vec<BaseVec>& threads, unsigned int min_vote = 0, 
            vec< std::pair<int,edit0> >* edits = 0 ) const ;
    ...
    void GetEdits( const String & align_a, const String & align_b, vec< std::pair<int,edit0> > *loc_eidts ) const;
...
public:
    ...
    int ScoreEdit( const std::pair<int, edit0>& loc_edit ) ;
    int ScoreEdit1( int ithread, const std::pair<int, edit0> & loc_edit ) ;

    const BaseVec& FounderSeq() const { return read0_; }
    void GetLocEdit1( int ithread, vec< std::pair<int,edit0> > *p_loc_edits ) const;
    void GetLocEdits( vec< std::pair<int, edit0> > *p_loc_edits, vec<unsigned int> *p_counts, unsigned int mis_vote=0 ) const;
    ...
    // command functions
    static void AlignToLocEdits( const String & align_a, const String & align_b, vec< std::pair<int,edit0> >* loc_edits );
    static BaseVec NewSeq( const BaseVec& read0,  const std::pair<int, edit0>& loc_edit );
