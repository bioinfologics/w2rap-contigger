  ...
  public:
    ...
    static void dispatch( int k, Args&&... args ) {
        ...
        case gK[28]:
            ...
            break;
        case gK[29]:
            C<gK[29]>()(std::forward<Args>(args)...);
            break;
        case gK[30]:
            C<gK[30]>()(std::forward<Args>(args)...);
            break;
        case gK[31]:
            C<gK[31]>()(std::forward<Args>(args)...);
            break;
        case gK[32]:
            C<gK[32]>()(std::forward<Args>(args)...);
            break;
        case gK[33]:
            C<gK[33]>()(std::forward<Args>(args)...);
            break;
        case gK[34]:
            C<gK[34]>()(std::forward<Args>(args)...);
            break;
        case gK[35]:
            C<gK[35]>()(std::forward<Args>(args)...);
            break;
        case gK[36]:
            C<gK[36]>()(std::forward<Args>(args)...);
            break;
        case gK[37]:
            C<gK[37]>()(std::forward<Args>(args)...);
            break;
        case gK[38]:
            C<gK[38]>()(std::forward<Args>(args)...);
            break;
        case gK[39]:
            C<gK[39]>()(std::forward<Args>(args)...);
            break;
        case gK[40]:
            C<gK[40]>()(std::forward<Args>(args)...);
            break;
        case gK[41]:
            C<gK[41]>()(std::forward<Args>(args)...);
            break;
        case gK[42]:
            C<gK[42]>()(std::forward<Args>(args)...);
            break;
        case gK[43]:
            C<gK[43]>()(std::forward<Args>(args)...);
            break;
        case gK[44]:
            C<gK[44]>()(std::forward<Args>(args)...);
            break;
        case gK[45]:
            C<gK[45]>()(std::forward<Args>(args)...);
            break;
        case gK[46]:
            C<gK[46]>()(std::forward<Args>(args)...);
            break;
        default:
