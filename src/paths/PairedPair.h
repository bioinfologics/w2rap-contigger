...
class istring : public vec<int> {
 ...
 public:
     ...
     friend std::ostream& operator<<( std::ostream& o, const istring& x );
};
...
class pp_pair {
     ...
     friend std::ostream& operator<<( std::ostream& o, const pp_pair& p );
     void Print( std::ostream& o, const vec<int>& L ) const;
...
class pp_mpair : public pp_pair {
     ...
     friend std::ostream& operator<<( std::ostream& o, const pp_mpair& p );
