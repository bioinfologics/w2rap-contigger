...
/**
   ...
   TEE (String)
     ...
     redirects std::cout to the specified list of files. Using this method instead of
...
class parsed_arg_help {
  ...
  public:
    ...
    friend std::ostream& operator<< ( std::ostream& out, const parsed_arg_help& the_arg );
...
class parsed_args {
  ...
  public:
    ...
    void PrintTheCommandPretty( std::ostream& out, const String& prefix = "" );
    ...
    /// redirects std::cout to the specified files.  This method
