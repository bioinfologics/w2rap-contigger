...
void print_signal_handler_message( int signal_number, siginfo_t* info ) {
    ...
    case SIGSEGV:
        std::cout << SIGSEGV_msg << std::endl;
        break;
    case SIGFPE:
        cout << SIGFPE_msg << std::endl;
        break;
    case SIGINT:
        cout << SIGINT_msg << std::endl;
        break;
    case SIGBUS:
        cout << SIGBUS_msg << std::endl;
        break;
    case SIGILL:
        cout << SIGILL_msg << std::endl;
        break;
    case SIGABRT:
        std::cout << SIGABRT_msg << std::endl;
        break;
    case SIGTERM:
        std::cout << SIGTERM_msg << std::endl;
        break;
    case SIGCHLD:
