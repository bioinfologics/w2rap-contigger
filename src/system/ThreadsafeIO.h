 ...
 *
 * To use the static instances that wrap std::cout and cerr, replace std::cout in your code with ThreadsafeOStreamFetcher::cout()
 * and cerr with ThreadsafeOStreamFetcher::cerr().  You can define a couple of macros to make this easier,
 * if you like, e.g., #define std::cout ThreadsafeOStreamFetcher::cout()
 */
