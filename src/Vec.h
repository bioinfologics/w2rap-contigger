...
// ===========================================================================
  ...
  vec( const std::initializer_list<T>& x, A const& a=A() ) : BaseT(x,a) {}
...
// ===========================================================================
  ...
  void append( const vec<T>& y, const vec<IDX>& entries ) {
    AssertLe(y.size(), std::numeric_limits<IDX>::max());
...
// ===========================================================================
  ...
  void SetToSubOf( const vec<T>& x, const vec<IDX>& indices ) {
    AssertLe(x.size(), std::numeric_limits<IDX>::max());
...
// ===========================================================================
  ...
  /// print values to std::ostream, separated by sep.
  ...
  void Println(std::ostream & os, const char * sep = " ") const {
    Print(os, sep); os << std::endl;
  }

  ///Set myself from text stream containing list of values of unknown length.
  void ReadFromTextStream(std::istream & is) {
    this->clear();
    T t;
    while (true) {
      is >> t;
...
void PrettyPrint( std::ostream& o, const vec<int>& v, int max_items = 0,
     String terminator = "\n" );

void PrettyPrint( std::ostream& o, const vec<longlong>& v, int max_items = 0,
     String terminator = "\n" );

void PrettyPrint( std::ostream& o, const vec<double>& v, int max_items = 0,
     String terminator = "\n" );

void PrettyPrint( std::ostream& o, const vec<TraceInt>& v, int max_items = 0,
     String terminator = "\n" );
...
template<class T> void CompactPrint( std::ostream& out, const vec<T>& v,
    String separator = " " )
...
{    ForceAssert( !IsRegularFile( f + ".gz" ) );
     ...
     {    std::ofstream out(f.c_str());
          out << std::setfill('0') << std::setw(15) << v.size() << std::setfill(' ') << '\n';
          for ( typename vec<T>::size_type i = 0; i <  v.size( ); i++ )
               out << v[i];
          out.close();   }
     else
     {    std::fstream out(f.c_str(),std::ios_base::in|std::ios_base::out);
          ...
          out << std::setfill('0') << std::setw(15) << n+v.size( ) << std::setfill(' ') << '\n';
...
std::ostream& operator<<(std::ostream& s, const vec<unsigned short>& v);
std::ostream& operator<<(std::ostream& s, const vec<int>& v);
std::ostream& operator<<(std::ostream& s, const vec<longlong>& v);
std::ostream& operator<<(std::ostream& s, const vec<float>& v);
std::ostream& operator<<(std::ostream& s, const vec<double>& v);
std::ostream& operator<<(std::ostream& s, const vec<String>& v);

template<class T> std::istream& operator>>(std::istream& s, vec<T>& v)
...
std::istream& operator>>(std::istream& s, vec<String>& v);
...
void PrintTabular( std::ostream& out, const vec< vec<String> >& rows, int sep,
     String justify = String( ) );

void PrintCSV(std::ostream& out, const vec< vec<String> >& rows);
