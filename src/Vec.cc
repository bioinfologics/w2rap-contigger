...
void PrettyPrint(std::ostream& o, const vec<int>& v, int max_items, String terminator)
{    int chars_in_line = 0;
...
void PrettyPrint(std::ostream& o, const vec<longlong>& v, int max_items, 
     String terminator)
{    int chars_in_line = 0;
...
void PrettyPrint(std::ostream& o, const vec<double>& v, int max_items, String terminator)
{    int chars_in_line = 0;
...
void PrettyPrint(std::ostream& o, const vec<TraceInt>& v, int max_items, String terminator)
{    int chars_in_line = 0;
