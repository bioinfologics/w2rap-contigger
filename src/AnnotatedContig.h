...
void Print( std::ostream &out ) const;
  ...
  static void SetStandards     ( const vec< basevector >          &standards       ) { standards_       = &standards;       }
  static void SetArachneContigs( const std::map< int, arachne_contig > &arachne_contigs ) { arachne_contigs_ = &arachne_contigs; }
  //---------------------------------------------------------------
...
class annotated_final_answer {
 ...
 public:
  ...
  const std::map< int, arachne_contig >&   RevealArachneContigs()  { return arachne_contigs_; }
