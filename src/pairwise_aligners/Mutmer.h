...
class mutmer {
  ...
  public:
    ...
    void TrimLeft( const int bases, const basevector &rd1, const basevector &rd2 ) {
        // std::cout << "Pre left trim by " << bases << ": " << std::endl;
        ...
        // std::cout << "Post left trim by " << bases << ": " << std::endl;
        // this->Print( cout, rd1, rd2 );
    }

    void TrimRight( const int bases, const basevector &rd1, const basevector &rd2 ) {
        // std::cout << "Pre right trim by " << bases << ": " << std::endl;
        // this->Print( cout, rd1, rd2 );
        if ( bases >= len_ ) {
            len_ = 0;
            e_ = 0;
        ...
        // std::cout << "Post right trim by " << bases << ": " << std::endl;
        // this->Print( cout, rd1, rd2 );
    }
    ...
    friend std::ostream & operator<< ( std::ostream &out, const mutmer &mm ) {
    ...
    void Print( std::ostream &out, const basevector &rd1, const basevector &rd2 );
...
struct mutmer_is_short : public std::unary_function<mutmer,bool> {
    int min_length;
