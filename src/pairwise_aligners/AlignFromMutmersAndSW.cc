...
// 	    cout << gap_errors << " errors." << std::endl;
       ...
       if ( basesleft > 0 )
       {
         cout << "Forcing proper alignment of " << basesleft << "bp hanging end on right." << std::endl;
...
//  	    << ", gap2=" << rd2_gap.ToString() << std::endl;
// 	    << " " << flush;
...
//        cout << gap_errors << " errors." << std::endl;
       ...
       if ( basesleft > 0 )
       {
         cout << "Forcing proper alignment of " << basesleft << "bp hanging end on left." << std::endl;
     ...
     {
//        cout << "gaps(" << j << ") = " << gaps(j) << std::endl;
//        cout << "lengths(" << j << ") = " << lengths(j) << std::endl;
