...
class superb {
  ...
  public:
    ...
    void Print( std::ostream& out, const String& super_name ) const;
    void Print( const Boolvector& s_rc, std::ostream& out,
                const String& super_name ) const;
    // PrintRange: print scaffolding information between two contigs (in one line).
    void PrintRange( std::ostream& out, const String& super_name,
