...
#ifndef W2RAP_CONTIGGER_PATHFINDER_H_PB
#define W2RAP_CONTIGGER_PATHFINDER_H_PB
...
class PathFinder_pb {
public:
    PathFinder_pb( HyperBasevector& hbv, vec<int>& inv, ReadPathVec& paths, VecULongVec& invPaths, int min_reads = 5 ) :
    mHBV(hbv),
    mInv(inv),
    mPaths(paths),
