                           ...
                           const unsigned verbosity) const 
{
  ...
  if (verbosity > 1) std::cout << "kf_ceil         = " << kf_ceil << std::endl;
  ...
  if (kf_min1_arg > kf_ceil) {
    cout << "**** Kmer frequencies are too low. Bad data?" << std::endl;
    return;
  }
  ...
  if (_kf_min1 > kf_ceil) {
    cout << "**** Could not find kmer spectrum local minimum. Bad data?" << std::endl;
    return;
  }
  
  if (verbosity > 1) std::cout << "kf_min1         = " << _kf_min1 << std::endl;
  ...
  if (verbosity > 1) std::cout << "kf_max2         = " << _kf_max2 << std::endl;

  if (_kf_max2 < kf_min1_arg) {
    cout << "**** Coverage too low. Can't estimate genome size." << std::endl;
    return;
  }
  ...
  if (verbosity > 1) std::cout << "kf_max1         = " << _kf_max1 << std::endl;
  ...
  if (verbosity > 1) std::cout << "kf_min2         = " << _kf_min2 << std::endl;
  ...
  if (_kf_min3 > kf_ceil) {
    cout << "**** Error analysing spectrum: kf_min3 (" << _kf_min3 << ") > kf_ceil (" << kf_ceil << ")." << std::endl;
    return;
  }

  if (verbosity > 1) std::cout << "kf_min3         = " << _kf_min3 << std::endl;

  if (verbosity > 1) std::cout << "kfs             :"
                    << " " << _kf_min1
                    << " " << _kf_max1
                    << " " << _kf_min2
                    << " " << _kf_max2
  ...
  if (verbosity > 1) std::cout << "kf_hi           = " << _kf_hi << std::endl;
  ...
  if (verbosity > 1) std::cout << "nk_total        = " << _nk_total       << std::endl;
  if (verbosity > 1) std::cout << "nk_bad_low_kf   = " << _nk_bad_low_kf  << std::endl;
  if (verbosity > 1) std::cout << "nk_good_snp     = " << _nk_good_snp    << std::endl;
  if (verbosity > 1) std::cout << "nk_good_uniq    = " << _nk_good_uniq   << std::endl;
  if (verbosity > 1) std::cout << "nk_good_rep     = " << _nk_good_rep    << std::endl;
  if (verbosity > 1) std::cout << "nk_bad_high_kf  = " << _nk_bad_high_kf << std::endl;
  ...
  if (verbosity > 1) std::cout << "ndk_total       = " << _ndk_total       << std::endl;
  if (verbosity > 1) std::cout << "ndk_bad_low_kf  = " << _ndk_bad_low_kf  << std::endl;
  if (verbosity > 1) std::cout << "ndk_good_snp    = " << _ndk_good_snp    << std::endl;
  if (verbosity > 1) std::cout << "ndk_good_uniq   = " << _ndk_good_uniq   << std::endl;
  if (verbosity > 1) std::cout << "ndk_good_rep    = " << _ndk_good_rep    << std::endl;
  if (verbosity > 1) std::cout << "ndk_bad_high_kf = " << _ndk_bad_high_kf << std::endl;


  // ---- kmer coverage C_K
 
  _kf_ave_uniq = double(_nk_good_uniq) / double(_ndk_good_uniq);
  if (verbosity > 1) std::cout << "kf_ave_uniq     = " << _kf_ave_uniq << std::endl;
  ...
  //if (verbosity > 1) std::cout << "read_len        = " << read_len << std::endl;
  //if (verbosity > 1) std::cout << "coverage        = " << _coverage << std::endl;
  ...
  if (_coverage < _coverage_min) {
    ...
    if (ploidy == 2) {
      ...
      if (verbosity > 1) std::cout << "SNP distance    = " << _d_SNP << std::endl;
    }
    ...
    // ---- Bias estimation
    {
      ...
      if (ploidy == 2) {
        ...
        if (verbosity > 1) std::cout << "alpha           = " << setprecision(5) << alpha << std::endl;
        if (verbosity > 1) std::cout << "sig2 SNP        = " << setprecision(5) << sig2_SNP << std::endl;
        if (verbosity > 1) std::cout << "sig SNP         = " << setprecision(5) << sqrt(sig2_SNP) << std::endl;
      }
      ...
      if (verbosity > 1) std::cout << "kf_min1         = " << _kf_min1 << std::endl;
      if (verbosity > 1) std::cout << "kf_min3         = " << _kf_min3 << std::endl;
      if (verbosity > 1) std::cout << "mu              = " << mu << std::endl;
      if (verbosity > 1) std::cout << "sig             = " << sig << std::endl;
      if (verbosity > 1) std::cout << "kf mean          = " << setprecision(5) << mu << std::endl;
      if (verbosity > 1) std::cout << "kf sig2          = " << setprecision(5) << sig2 << std::endl;
      if (verbosity > 1) std::cout << "kf sig           = " << setprecision(5) << sig << std::endl;
      if (verbosity > 1) std::cout << "kf sig/mean      = " << setprecision(5) << sig / mu << std::endl;
      ...
      if (verbosity > 1) std::cout << "sig2_bias       = " << setprecision(5) << sig2_bias << std::endl;
      if (verbosity > 1) std::cout << "stddev_bias     = " << setprecision(5) << _stddev_bias << std::endl;
                                ...
                                const unsigned verbosity) const 
{
  ...
  if (verbosity) 
    cout << tag() << "Writing kmer spectrum to '" << fn << "'." << std::endl;
                                  ...
                                  const unsigned verbosity)
{
  ...
  const String fn = head_K(head) + ".kspec";
  if (verbosity) 
    cout << tag() << "Reading kmer spectrum from '" << fn << "'." << std::endl;
...
void KmerQualitySpectra::to_text_file(const String & head) const 
{
  ...
  {
    os << "# index [0]: 1:quality  2-5:num_distinct_kmers 6-9:num_kmers" << std::endl;
    size_t cndk = 0;
    size_t cnk = 0;
  ...
  {
    os << "# index [1]: 1:kmer_freq 2-...:num_distinct_kmers[q]" << std::endl;
    for (size_t kf = 0; kf != nkf; kf++) {
      if ((*this)[0][kf] != 0) {
        os << setw(12) << kf;
  ...
  {
    os << "# index [2]: 1:kmer_freq 2-...:num_distinct_kmers[q] / total_num_distinct_kmers" << std::endl;
    for (size_t kf = 0; kf != nkf; kf++) {
      if ((*this)[0][kf] != 0) {
        os << setw(12) << kf;
  ...
  {
    os << "# index [3]: 1:kmer_freq 2-...:cumulative_num_distinct_kmers[q]" << std::endl;
  ...
  {
    os << "# index [4]: 1:kmer_freq 2-...:cumulative_num_distinct_kmers[q] / total_num_distinct_kmers" << std::endl;
    vec<size_t> cndk(nq, 0);
    for (size_t kf = 0; kf != nkf; kf++) {
      if ((*this)[0][kf] != 0) {
        os << setw(12) << kf;
  ...
  {
    os << "# index [5]: 1:kmer_freq 2-...:num_kmers[q] = kmer_freq * num_distinct_kmers[q]" << std::endl;
    for (size_t kf = 0; kf != nkf; kf++) {
      if ((*this)[0][kf] != 0) {
        os << setw(12) << kf;
  ...
  {
    os << "# index [6]: 1:kmer_freq 2-...:num_kmers[q] / total_num_kmers" << std::endl;
    for (size_t kf = 0; kf != nkf; kf++) {
      if ((*this)[0][kf] != 0) {
        os << setw(12) << kf;
  ...
  {
    os << "# index [7]: 1:kmer_freq 2-...:cumulative_num_kmers[q]" << std::endl;
    vec<size_t> cnk(nq, 0);
    for (size_t kf = 0; kf != nkf; kf++) {
      if ((*this)[0][kf] != 0) {
        os << setw(12) << kf;
  ...
  {
    os << "# index [8]: 1:kmer_freq 2-...:cumulative_num_kmers[q] / total_num_kmers" << std::endl;
    vec<size_t> cnk(nq, 0);
    for (size_t kf = 0; kf != nkf; kf++) {
      if ((*this)[0][kf] != 0) {
        os << setw(12) << kf;
