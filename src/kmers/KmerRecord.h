...
DEFINE_BYTE_PAC_LESS(108)
DEFINE_BYTE_PAC_LESS(116)
DEFINE_BYTE_PAC_LESS(128)
DEFINE_BYTE_PAC_LESS(136)
DEFINE_BYTE_PAC_LESS(144)
DEFINE_BYTE_PAC_LESS(152)
DEFINE_BYTE_PAC_LESS(160)
DEFINE_BYTE_PAC_LESS(168)
DEFINE_BYTE_PAC_LESS(172)
DEFINE_BYTE_PAC_LESS(180)
DEFINE_BYTE_PAC_LESS(188)
DEFINE_BYTE_PAC_LESS(192)
DEFINE_BYTE_PAC_LESS(196)
DEFINE_BYTE_PAC_LESS(200)
DEFINE_BYTE_PAC_LESS(208)
DEFINE_BYTE_PAC_LESS(216)
DEFINE_BYTE_PAC_LESS(224)
DEFINE_BYTE_PAC_LESS(232)
DEFINE_BYTE_PAC_LESS(240)
DEFINE_BYTE_PAC_LESS(260)
DEFINE_BYTE_PAC_LESS(280)
DEFINE_BYTE_PAC_LESS(300)
...
template<int K, int I = 1> class kmer_record {
  ...
  public:
    ...
    kmer_record() {
        /*STATIC_ASSERT_M(0==K%4, K_not_multiple_4);*/
    }
    ...
    void FromString( std::istream & in ) {
        int id;
        int pos;
        String str_bases;
        in >> id >> pos >> str_bases;
    ...
    friend std::ostream & operator<<(std::ostream & out, const kmer_record& krec) {
        krec.ToString(out);
        return out;
    }

    friend std::istream & operator>> ( std::istream &in, kmer_record &krec ) {
        krec.FromString( in );
        return in;
    }
...
struct LessByIdAndPos:
    public std::binary_function<KmerRecord, KmerRecord, bool> {
...
std::ostream& operator<< ( std::ostream& s, const kmer< K >& k ) {
    basevector b;
    k.GetBasevector( b );
    b.Print( s );
    return s;
...
template < nbases_t K > inline
std::ostream& operator<< ( std::ostream& s, const kmer_with_count< K >& k ) {
    basevector b;
    k.GetBasevector( b );
    b.Print( s );
    return s;
