...
template void kmer<108>::SetToSubOf( const basevector&, const size_type );
template void kmer<116>::SetToSubOf( const basevector&, const size_type );
template void kmer<128>::SetToSubOf( const basevector&, const size_type );
template void kmer<136>::SetToSubOf( const basevector&, const size_type );
template void kmer<144>::SetToSubOf( const basevector&, const size_type );
template void kmer<152>::SetToSubOf( const basevector&, const size_type );
template void kmer<160>::SetToSubOf( const basevector&, const size_type );
template void kmer<168>::SetToSubOf( const basevector&, const size_type );
template void kmer<172>::SetToSubOf( const basevector&, const size_type );
template void kmer<180>::SetToSubOf( const basevector&, const size_type );
template void kmer<188>::SetToSubOf( const basevector&, const size_type );
template void kmer<192>::SetToSubOf( const basevector&, const size_type );
template void kmer<196>::SetToSubOf( const basevector&, const size_type );
template void kmer<200>::SetToSubOf( const basevector&, const size_type );
template void kmer<208>::SetToSubOf( const basevector&, const size_type );
template void kmer<216>::SetToSubOf( const basevector&, const size_type );
template void kmer<224>::SetToSubOf( const basevector&, const size_type );
template void kmer<232>::SetToSubOf( const basevector&, const size_type );
template void kmer<240>::SetToSubOf( const basevector&, const size_type );
template void kmer<260>::SetToSubOf( const basevector&, const size_type );
template void kmer<280>::SetToSubOf( const basevector&, const size_type );
template void kmer<300>::SetToSubOf( const basevector&, const size_type );
