...
public:
  ...
  {
    std::cout << "  q_sum: ";
    for (size_t base = 0; base != 4; base++) std::cout << " " << std::setw(5) << q_sum[base];
    std::cout << "  n_q_high: ";
    for (size_t base = 0; base != 4; base++) std::cout << " " << std::setw(2) << n_q_high[base];
    std::cout << "  Win: " << base_winner;
    std::cout << "  fix_base: ";
    for (size_t base = 0; base != 4; base++) std::cout << unsigned(fix_base[base]);
    std::cout << std::endl;
  }
...
public:
                         ...
                         const BaseColumn & col)
  {
	...
	std::sort(i_base_i_krec.begin(), i_base_i_krec.end());
	...
	for (unsigned q = 0; q < 42; q++) {
	  oss << "quals: " << std::setw(3) << q;
	  for (unsigned b = 0; b < 4; b++)
	    oss << " " << std::setw(10) << col.nq[b][q];
	  oss << std::endl;
	}
	oss << "quals: " << std::endl;
      }
