...
public:
  ...
  : BaseT(std::less<size_t>(),a) { *this = that; }
  ...
  void Write(const String & filename) const
  {
    ...
    ofs << "# 1:x 2:y 3:y/total 4:cum(y) 5:cum(y)/total" << std::endl;
    ...
    for (MapOfCounters::const_iterator it = (*this).begin(); 
      ...
      ofs << " " << it->first
          << " " << it->second
          << " " << std::setprecision(10) << static_cast<double>(it->second) / total
          << " " << cum
          << " " << std::setprecision(10) << static_cast<double>(cum) / total
          << std::endl;
    }
    ofs.close();
  }
  ...
  void Write(const String & filename) const
  {
    ...
    for (KmerFrequencyCounters::const_iterator it = (*this).begin(); 
      ...
      outfs << " " << kmer_frequency 
            << " " << num_distinct_kmers
            << " " << std::setprecision(10) << static_cast<double>(num_distinct_kmers) / static_cast<double>(total_num_distinct_kmers) 
            << " " << cum_num_distinct_kmers 
            << " " << std::setprecision(10) << static_cast<double>(cum_num_distinct_kmers) / static_cast<double>(total_num_distinct_kmers) 
            << " " << num_kmers
            << " " << std::setprecision(10) << static_cast<double>(num_kmers) / static_cast<double>(total_num_kmers) 
            << " " << cum_num_kmers 
            << " " << std::setprecision(10) << static_cast<double>(cum_num_kmers) / static_cast<double>(total_num_kmers) 
            << std::endl;
    }
...
public:
  GenomeSizeEstimator(const KmerFrequencyCounters & kfc)
  {
    ...
    //std::cout << "kf_mode = " << _kf_mode << std::endl;
    ...
    //std::cout << "kf_max = " << kf_max << std::endl;
    ...
    //std::cout << "nk_total = " << _nk_total << std::endl;
    //std::cout << "nk_bad_low_kf = " << _nk_bad_low_kf << std::endl;
    //std::cout << "nk_good_uniq = " << _nk_good_uniq << std::endl;
    //std::cout << "nk_good_rep = " << _nk_good_rep << std::endl;
    //std::cout << "nk_bad_high_kf = " << _nk_bad_high_kf << std::endl;
    ...
    //std::cout << "ndk_total = " << _ndk_total << std::endl;
    //std::cout << "ndk_bad_low_kf = " << _ndk_bad_low_kf << std::endl;
    //std::cout << "ndk_good_uniq = " << _ndk_good_uniq << std::endl;
    //std::cout << "ndk_good_rep = " << _ndk_good_rep << std::endl;
    //std::cout << "ndk_bad_high_kf = " << _ndk_bad_high_kf << std::endl;
  }
