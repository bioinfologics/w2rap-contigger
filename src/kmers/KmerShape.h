...
#define DISPATCH_ON_KSHAPE(shapeId,handleShape) do {                        \
     ...
     if (!foundKShape) {                                                    \
         std::cout << "Not implemented for KSHAPE=" << shapeId << "." << std::endl;   \
...
#define DISPATCH_ON_K_WITH_K_PLUS_1(Kvar,handleK) do {                               \
     ...
     if (!foundK) {                                                    \
         std::cout << "KmerShape.h-1 Not implemented for K=" << Kvar << "." << std::endl;      \
         TracebackThisProcess();                                       \
     }                                                                 \
  } while(0)
...
#define DISPATCH_ON_K(Kvar,handleK) do {                               \
     ...
     if (!foundK) {                                                    \
         std::cout << "KmerShape.h-2 Not implemented for K=" << Kvar << "." << std::endl;      \
         TracebackThisProcess();                                       \
     }                                                                 \
  } while(0)
