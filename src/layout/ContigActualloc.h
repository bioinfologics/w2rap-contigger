...
std::ostream& operator<<( std::ostream &o, const arachne_contig   &a );

std::istream& operator>>( std::istream &i, contig_actualloc &a );
std::istream& operator>>( std::istream &i, arachne_contig   &a );

typedef std::map< int, arachne_contig > arachne_contig_itr;
